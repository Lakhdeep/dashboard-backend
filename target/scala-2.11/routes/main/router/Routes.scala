...
class Routes(
  ...
  // @LINE:11
  private[this] lazy val controllers_Application_getLog2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("travisLog")))
  )
  private[this] lazy val controllers_Application_getLog2_invoker = createInvoker(
    Application_1.getLog(),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "getLog",
